...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FieldOps.Domain.Invoices.Invoice", b =>
                {
                    ...
                    b.HasIndex("WorkOrderId")
                        .HasDatabaseName("ix_invoices_work_order_id");

                    b.HasIndex("OrganizationId", "CustomerId")
                        .HasDatabaseName("ix_invoices_organization_id_customer_id");
                    ...
                    b.ToTable("invoices", null, t =>
                        {
                            t.HasCheckConstraint("ck_invoices_amount_paid", "amount_paid >= 0");

                            t.HasCheckConstraint("ck_invoices_amount_paid_le_total", "amount_paid <= total");
            ...
            modelBuilder.Entity("FieldOps.Domain.Invoices.InvoiceLine", b =>
                {
                    ...
                    b.Property<Guid?>("SourceVisitMaterialId")
                        .HasColumnType("uuid")
                        .HasColumnName("source_visit_material_id");
                    ...
                    b.HasIndex("SourceQuoteLineId")
                        .HasDatabaseName("ix_invoice_lines_source_quote_line_id");

                    b.HasIndex("SourceVisitMaterialId")
                        .HasDatabaseName("ix_invoice_lines_source_visit_material_id");

                    b.ToTable("invoice_lines", null, t =>
                        {
                            t.HasCheckConstraint("ck_invoice_lines_quantity", "quantity > 0");

                            t.HasCheckConstraint("ck_invoice_lines_unit_price", "unit_price >= 0");
                        });
                });
            ...
            modelBuilder.Entity("FieldOps.Domain.Invoices.PaymentAllocation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("PaymentId", "InvoiceId")
                        .IsUnique()
                        .HasDatabaseName("ix_payment_allocations_payment_id_invoice_id");
            ...
            modelBuilder.Entity("FieldOps.Domain.Notifications.AuditLog", b =>
                {
                    ...
                    b.HasIndex("BranchId")
                        .HasDatabaseName("ix_audit_logs_branch_id");
            ...
            modelBuilder.Entity("FieldOps.Domain.Notifications.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("RecipientContactId")
                        .HasDatabaseName("ix_notifications_recipient_contact_id");
                    ...
                    b.ToTable("notifications", null, t =>
                        {
                            t.HasCheckConstraint("ck_notifications_channel", "channel IN ('email','sms','in_app')");
                        });
                });
            ...
            modelBuilder.Entity("FieldOps.Domain.Invoices.Invoice", b =>
                {
                    ...
                    b.HasOne("FieldOps.Domain.WorkOrders.WorkOrder", null)
                        ...
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("fk_invoices_work_orders_work_order_id");
            ...
            modelBuilder.Entity("FieldOps.Domain.Invoices.InvoiceLine", b =>
                {
                    ...
                    b.HasOne("FieldOps.Domain.Quotes.QuoteLine", null)
                        .WithMany()
                        .HasForeignKey("SourceQuoteLineId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .HasConstraintName("fk_invoice_lines_quote_lines_source_quote_line_id");

                    b.HasOne("FieldOps.Domain.WorkOrders.VisitMaterial", null)
                        .WithMany()
                        .HasForeignKey("SourceVisitMaterialId")
                        .OnDelete(DeleteBehavior.NoAction)
            ...
            modelBuilder.Entity("FieldOps.Domain.Invoices.Payment", b =>
                {
                    ...
                    b.HasOne("FieldOps.Domain.Users.User", null)
                        ...
                        .OnDelete(DeleteBehavior.NoAction)
                        .HasConstraintName("fk_payments_users_recorded_by_user_id");
                    ...
                    b.HasOne("FieldOps.Domain.Customers.Customer", null)
                        ...
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("fk_payments_customers_organization_id_customer_id");
                });
            ...
            modelBuilder.Entity("FieldOps.Domain.Notifications.AuditLog", b =>
                {
                    ...
                    b.HasOne("FieldOps.Domain.Branches.Branch", null)
                        ...
                        .HasForeignKey("BranchId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .HasConstraintName("fk_audit_logs_branches_branch_id");
            ...
            modelBuilder.Entity("FieldOps.Domain.Notifications.Notification", b =>
                {
                    ...
                    b.HasOne("FieldOps.Domain.Customers.CustomerContact", null)
                        ...
                        .OnDelete(DeleteBehavior.NoAction)
                        .HasConstraintName("fk_notifications_customer_contacts_recipient_contact_id");
